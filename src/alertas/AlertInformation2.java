 ...
 */
public class AlertInformation2 extends javax.swing.JDialog {
    ...
    public AlertInformation2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("<html>No puedes poner este equipo como pago<br>por que no ha sido reparado aun.<html>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertInformation2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertInformation2 dialog = new AlertInformation2(new javax.swing.JFrame(), true);
