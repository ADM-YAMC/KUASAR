 ...
 * @author Alex Carrera
 */
public class AlertWarning1 extends javax.swing.JDialog {
    ...
    public AlertWarning1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("El campo id equipo no pueden estar vacio");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertWarning1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertWarning1 dialog = new AlertWarning1(new javax.swing.JFrame(), true);
