 ...
 * @author Alex Carrera
 */
public class AlertSuccessCorreo extends javax.swing.JDialog {
    ...
    public AlertSuccessCorreo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Correo enviado exitosamente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertSuccessCorreo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertSuccessCorreo dialog = new AlertSuccessCorreo(new javax.swing.JFrame(), true);
