 ...
 * @author Alex carrera
 */
public class AlertSuccessActualizar extends javax.swing.JDialog {
    ...
    public AlertSuccessActualizar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Actualizacion exitosa");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertSuccessActualizar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertSuccessActualizar dialog = new AlertSuccessActualizar(new javax.swing.JFrame(), true);
