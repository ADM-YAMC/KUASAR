 ...
 * @author Alex carrera
 */
public class AlertWarningCambiar extends javax.swing.JDialog {
     ...
     */
    public AlertWarningCambiar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("¿Quieres cambiar la session?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertWarningCambiar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertWarningCambiar dialog = new AlertWarningCambiar(new javax.swing.JFrame(), true);
