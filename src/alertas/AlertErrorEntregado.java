 ...
 * @author Alex carrera
 */
public class AlertErrorEntregado extends javax.swing.JDialog {
     ...
     */
    public AlertErrorEntregado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("<html>Este equipo fue entrgado ya, asi que no<br>puede ejercer ningun cambio sobre el.<html>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertErrorEntregado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertErrorEntregado dialog = new AlertErrorEntregado(new javax.swing.JFrame(), true);
