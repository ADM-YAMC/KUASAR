 ...
 * @author Alex Carrera
 */
public class AlertSuccess1 extends javax.swing.JDialog {
    ...
    public AlertSuccess1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Reporte de factura enviado con exito");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertSuccess1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertSuccess1 dialog = new AlertSuccess1(new javax.swing.JFrame(), true);
