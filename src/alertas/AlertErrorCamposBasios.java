 ...
 * @author Alex carrera
 */
public class AlertErrorCamposBasios extends javax.swing.JDialog {
     ...
     */
    public AlertErrorCamposBasios(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("LLene los campos vacios");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertErrorCamposBasios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertErrorCamposBasios dialog = new AlertErrorCamposBasios(new javax.swing.JFrame(), true);
