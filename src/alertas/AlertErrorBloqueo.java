 ...
 * @author Alex carrera
 */
public class AlertErrorBloqueo extends javax.swing.JDialog {
     ...
     */
    public AlertErrorBloqueo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("<html>Usted ha sido bloqueado del sistema. Para<br>mas detalles contacte al administrador.<html>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertErrorBloqueo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertErrorBloqueo dialog = new AlertErrorBloqueo(new javax.swing.JFrame(), true);
