 ...
 * @author Alex carrera
 */
public class AlertSuccess2 extends javax.swing.JDialog {
     ...
     */
    public AlertSuccess2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Reporte creado exitosamente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertSuccess2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertSuccess2 dialog = new AlertSuccess2(new javax.swing.JFrame(), true);
