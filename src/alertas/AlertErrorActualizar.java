 ...
 * @author Alex carrera
 */
public class AlertErrorActualizar extends javax.swing.JDialog {
     ...
     */
    public AlertErrorActualizar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Error al actualizar los datos del equipo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertErrorActualizar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertErrorActualizar dialog = new AlertErrorActualizar(new javax.swing.JFrame(), true);
