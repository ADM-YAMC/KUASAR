 ...
 * @author Alex carrera
 */
public class AlertInformation3 extends javax.swing.JDialog {
     ...
     */
    public AlertInformation3(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("<html>No pudimos encontrar ese nombre<br>en nuestra base de datos<html>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertInformation3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertInformation3 dialog = new AlertInformation3(new javax.swing.JFrame(), true);
