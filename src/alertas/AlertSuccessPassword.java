 ...
 * @author Alex carrera
 */
public class AlertSuccessPassword extends javax.swing.JDialog {
    ...
    public AlertSuccessPassword(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Modificacion exitosa");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertSuccessPassword.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertSuccessPassword dialog = new AlertSuccessPassword(new javax.swing.JFrame(), true);
