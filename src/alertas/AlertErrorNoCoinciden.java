 ...
 * @author Alex carrera
 */
public class AlertErrorNoCoinciden extends javax.swing.JDialog {
     ...
     */
    public AlertErrorNoCoinciden(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertErrorNoCoinciden.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertErrorNoCoinciden dialog = new AlertErrorNoCoinciden(new javax.swing.JFrame(), true);
