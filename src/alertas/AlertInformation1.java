 ...
 * @author Alex carrera
 */
public class AlertInformation1 extends javax.swing.JDialog {
     ...
     */
    public AlertInformation1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("El campo buscar no puede estar vacio");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlertInformation1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlertInformation1 dialog = new AlertInformation1(new javax.swing.JFrame(), true);
